...
(function (global, factory) {
  ...
  function sameVnode(a, b) {
    return (
      a.key === b.key && ((a.tag === b.tag && a.isComment === b.isComment && isDef(a.data) === isDef(b.data) && sameInputType(a, b)) || (isTrue(a.isAsyncPlaceholder) && a.asyncFactory === b.asyncFactory && isUndef(b.asyncFactory.error)))
    );
  }
  ...
  function genScopedSlot(key, el, state) {
    ...
    var fn =
      'function(' + String(el.slotScope) + '){' + 'return ' + (el.tag === 'template' ? (el.if ? el.if + '?' + (genChildren(el, state) || 'undefined') + ':undefined' : genChildren(el, state) || 'undefined') : genElement(el, state)) + '}';
